...
(function() {
  var Base, Darwin, Linux, Posix, Win32, lst, pathmod, sym, uc1, _eng, _i, _klass, _len, _ref,
    __slice = [].slice,
  ...
  Posix = (function(_super) {
    ...
    Posix.prototype.home = function(opts) {
      ...
      ret = (f = (_ref = this.hooks) != null ? _ref.get_home : void 0) != null ? f() : process.env.HOME;
      if (opts.array) {
  ...
  exports.new_eng = function(args) {
    return new _klass(args);
  };
